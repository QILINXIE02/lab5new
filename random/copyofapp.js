function updateGreeting() {
    ...
    if (name) {
        greetingElement.textContent = `Hey, ${name}! Thanks for visitng our shop. If you are ready to order, please call =1 503 ### #####`;
    } else {
...
function displaySandwichImages() {
    ...
    if (!isNaN(sandwichCount) && sandwichCount > 0) {
        for (let i = 1; i <= sandwichCount; i++) {
            const image = document.createElement('img');
            image.src = 'https://media.istockphoto.com/vectors/sandwich-vector-icon-vector-id701007194?k=6&m=701007194&s=612x612&w=0&h=7xt_UwMubh9S9yF8GhbYvEzH393HseBd715UpXQbJNw='; //link
